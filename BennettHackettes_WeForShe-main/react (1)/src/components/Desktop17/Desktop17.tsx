...
import classes from './Desktop17.module.css';
...
/* @figmaId 2518:836 */
export const Desktop17: FC<Props> = memo(function Desktop17(props = {}) {
  return (
    <div className={`${resets.clapyResets} ${classes.root}`}>
      ...
      <div className={classes.tinywow_change_bg_photo_601720}></div>
    </div>
  );
});
